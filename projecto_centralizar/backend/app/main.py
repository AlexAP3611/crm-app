...
from app.routers import auth, contacts, csv, enrichment, master_data, campaigns, system, access_requests, users, logs, empresas, activity, affino_accounts
...
app.include_router(affino_accounts.router)
