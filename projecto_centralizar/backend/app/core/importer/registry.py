...
EMPRESA_REGISTRY.register("web", ["empresa_web", "web", "website", "url", "site", "empresa_web"], priority=20)
EMPRESA_REGISTRY.register("email", ["empresa_email", "email", "correo", "mail", "empresa_email"], priority=20)
EMPRESA_REGISTRY.register("phone", ["empresa_phone", "phone", "telefono", "tel", "mobile", "empresa_telefono", "telefono empresa"], priority=20)
EMPRESA_REGISTRY.register("cif", ["empresa_cif", "cif", "vat", "vat_number", "empresa_cif"], priority=20)
EMPRESA_REGISTRY.register("numero_empleados", ["numero_empleados", "employees", "size", "empleados", "num_empleados"], priority=10)
...
EMPRESA_REGISTRY.register("vertical_name", ["vertical", "subsector", "verticales"], priority=10)
EMPRESA_REGISTRY.register("product_name", ["producto", "product", "servicio", "productos"], priority=10)
