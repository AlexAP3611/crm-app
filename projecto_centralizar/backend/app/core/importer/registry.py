...
EMPRESA_REGISTRY.register("cif", ["empresa_cif", "cif", "vat", "vat_number", "empresa_cif", "CIF empresa"], priority=20)
...
EMPRESA_REGISTRY.register("cnae", ["cnae", "industry_code", "actividad", "CNAE"], priority=10)
