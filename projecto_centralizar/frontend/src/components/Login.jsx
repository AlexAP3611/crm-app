                ...
                <div className="w-full max-w-[480px]">
                    <div className="mb-12 text-center md:text-left">
                        ...
                        <p className="font-body text-on-surface-variant text-lg leading-relaxed">
                            Accede al <span className="text-primary font-semibold italic">Registro Arquitectónico</span> de la inteligencia de tu negocio.
                        </p>
                    </div>
                    ...
                    <footer className="mt-12 text-center pb-8">
                        ...
                        <div className="flex justify-center gap-6 mt-4">
                            <span className="font-label text-[10px] text-outline-variant hover:text-primary uppercase tracking-widest transition-colors cursor-pointer">Privacidad</span>
                            <span className="font-label text-[10px] text-outline-variant hover:text-primary uppercase tracking-widest transition-colors cursor-pointer">Términos</span>
                            <span className="font-label text-[10px] text-outline-variant hover:text-primary uppercase tracking-widest transition-colors cursor-pointer">Auditoría Automática</span>
                        </div>
                    </footer>
                </div>
            </main>
